...
public class predictModel {
	...
	static {
		byte[] chineseModel;
		try {
		chineseModel = Files.readAllBytes(Paths.get("E://java_workspace/project/model/scut_all_9459.pb"));
		...
		specialCharModel = Files.readAllBytes(Paths.get("E://java_workspace/project/model/mobilenet_66.pb"));
		...
		byte[] delModel = Files.readAllBytes(Paths.get("E://java_workspace/project/model/dele_conv4.pb"));// 94
	...
	public static void readChineseLabel() {
		String pathname = "E://java_workspace/project/model/scut_all_9459";
